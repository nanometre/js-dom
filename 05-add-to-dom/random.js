...
btn.addEventListener('click', function(){
    ...
    // for the code below to work, need to use `` quotes
    // works but almost impossible to add an event listener to the <li> that we just created
...
document.querySelector('#btnAddName')
    .addEventListener('click', function () {
        ...
        // can add event listener to the <li> element that we created
